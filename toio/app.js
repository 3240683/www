...
// 8方向走行のマッピング（1:前進, 2:後退）
const RANDOM_DIRECTIONS = [
  { id: 'n',  name: '前進',       leftSpeed: 60, leftDir: 1, rightSpeed: 60, rightDir: 1 },
  { id: 'ne', name: '右斜め前',   leftSpeed: 60, leftDir: 1, rightSpeed: 20, rightDir: 1 },
  { id: 'e',  name: '右超信地旋回',leftSpeed: 50, leftDir: 1, rightSpeed: 50, rightDir: 2 },
  { id: 'se', name: '右斜め後',   leftSpeed: 60, leftDir: 2, rightSpeed: 20, rightDir: 2 },
  { id: 's',  name: '後退',       leftSpeed: 60, leftDir: 2, rightSpeed: 60, rightDir: 2 },
  { id: 'sw', name: '左斜め後',   leftSpeed: 20, leftDir: 2, rightSpeed: 60, rightDir: 2 },
  { id: 'w',  name: '左超信地旋回',leftSpeed: 50, leftDir: 2, rightSpeed: 50, rightDir: 1 },
  { id: 'nw', name: '左斜め前',   leftSpeed: 20, leftDir: 1, rightSpeed: 60, rightDir: 1 },
